...
public class OmikujiService {
    ...
    switch(result){
    case "大吉": resultComment="ランチに入ったお店でサービスしてもらえるかも";
    	break ;
    case "中吉": resultComment="風邪引かないかも";
    	break ;
    case "小吉": resultComment="なぜか髪サラサラになるかも";
    	break ;
    case "吉" : resultComment="悩み事解決のヒントが見つかるかも";
    	break ;
    case "末吉": resultComment="買い物で小銭をぴったり出せるかも";
    	break ;
    case "凶": resultComment="コーヒー買うのに万札しかないかも";
    	break ;
    case "大凶": resultComment="コインパーキングで別車の清算しちゃうかも";
    	break ;
    }
